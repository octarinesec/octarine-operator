...
func (m *MockApiGateway) GetConfigurationChanges(arg0 context.Context) ([]models.ConfigurationChange, error) {
	m.ctrl.T.Helper()
...
func (mr *MockApiGatewayMockRecorder) GetConfigurationChanges(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetConfigurationChanges", reflect.TypeOf((*MockApiGateway)(nil).GetConfigurationChanges), arg0)
}
