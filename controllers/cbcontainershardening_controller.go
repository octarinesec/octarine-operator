...
// CBContainersHardeningReconciler reconciles a CBContainersHardening object
...
// the CBContainersHardening object against the actual cluster state, and then
...
func (r *CBContainersHardeningReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&operatorcontainerscarbonblackiov1.CBContainersHardening{}).
		Complete(r)
}
